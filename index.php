	...
	else
	{
		...
		if ($_SESSION['level'] == 9){   
			...
			echo '<table class="borde" cellpading="1" cellspacing="0" width="1000">
					...
					<form name="ordenform" method="post" action="index.php">
					<input type="hidden" name="orden" size="1"></input>
					<tr>
						<td width="50" align="center">
							<b><font face="Arial">ID</font></b>
							<input type="image" src="images/flecha_arriba.jpg" title="ORDENAR" onclick="js_ordenar(1)"></input>
							<input type="image" src="images/flecha_abajo.jpg" title="ORDENAR" onclick="js_ordenar(2)"></input>
						</td>
						<td width="60" align="center">
							<b><font face="Arial">C.P.</font></b>
							<input type="image" src="images/flecha_arriba.jpg" title="ORDENAR" onclick="js_ordenar(3)"></input>
							<input type="image" src="images/flecha_abajo.jpg" title="ORDENAR" onclick="js_ordenar(4)"></input>
						</td>
						<td width="290" align="center">
							<b><font face="Arial">TIPO INCIDENCIA</font></b>
							<input type="image" src="images/flecha_arriba.jpg" title="ORDENAR" onclick="js_ordenar(5)"></input>
							<input type="image" src="images/flecha_abajo.jpg" title="ORDENAR" onclick="js_ordenar(6)"></input>
						</td>
						...
						<td width="170" align="center">
							...
							<input type="image" src="images/flecha_arriba.jpg" title="ORDENAR" onclick="js_ordenar(7)"></input>
							<input type="image" src="images/flecha_abajo.jpg" title="ORDENAR" onclick="js_ordenar(8)"></input>
						</td>							
						<td width="40" align="center"><b></b></td>
						<td width="50" align="center"><b></b></td>
						<td width="60" align="center">
							<img src="images/process_warning.png" alt="NO IMAGEN"></img>
							<input type="image" src="images/flecha_arriba.jpg" title="ORDENAR" onclick="js_ordenar(9)"></input>
							<input type="image" src="images/flecha_abajo.jpg" title="ORDENAR" onclick="js_ordenar(10)"></input>
						</td>
					</tr>
					</form>';
					while ($datos=mysqli_fetch_array($res_abiertas))
						{	
							...
							if ($datos["PLAZO"]<345600){ //4 DIA
								echo '<img border="0" src="images/plazo_verde.gif" width="20" title="EN PLAZO" alt="NO IMAGEN"></img>';
							}else if ($datos["PLAZO"]<604800){//7 DIAS
								echo '<img border="0" src="images/plazo_amarillo.gif" width="20" title="PLAZO SUPERADO" alt="NO IMAGEN"></img>';
							}else {
								echo '<img border="0" src="images/plazo_rojo.gif" width="20" title="DEMORA EXCESIVA" alt="NO IMAGEN"></img>';
							} 
			...
			echo '<table class="borde" cellpading="1" cellspacing="0" width="1000">
					...
					echo '</table><br /><a href="busqueda.php" title="BUSCAR"><img border="0" src="images/ver_mas.gif" alt="NO FOTO"></img></a>
					
				
					<blockquote><blockquote><blockquote><blockquote><blockquote><blockquote><blockquote>
					<form id="filtro" method="post" action="filtrar.php">
					<label>';
					if ($f_coordinacion == 1){
