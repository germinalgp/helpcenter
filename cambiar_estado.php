<?php
	/**
	* PHP para cambiar el estado de una incidencia. Podemos definir mas estados en funcion de las necesidades de la empresa.
	* Actualmente los estados son ABIERTA, EN TRAMITE O CERRADA
